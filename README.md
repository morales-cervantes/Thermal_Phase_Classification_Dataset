...
- **Raw Thermograms** (`/Raw_Thermograms_CSV/`):  
  Time-series thermal data (in CSV) from five controlled high-temperature oxidation experiments on AISI 1045 steel.
...
A total of 3356 thermographic records were compiled, covering heating, isothermal, and cooling phases.
...
Five machine learning models (Random Forest, MLP, SVM, KNN, XGBoost) were trained and validated (5-fold CV) for automatic classification of thermal phases.
